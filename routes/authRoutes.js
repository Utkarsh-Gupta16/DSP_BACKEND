...
router.get(
  ...
  (req, res, next) => {
    ...
    console.log("Redirect URI:", process.env.NODE_ENV === "production" ? "https://dsp-backend.onrender.com/api/auth/google/callback" : "http://localhost:5000/api/auth/google/callback");
